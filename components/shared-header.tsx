...
export default function SharedHeader() {
  ...
  return (
    <header className="sticky w-full items-center top-0 z-40 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container w-full flex h-16 items-center mx-auto justify-between py-4">
